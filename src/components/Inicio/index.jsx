...
const Inicio = () => {
    const {translateHome1, translateHome2, translateHome3, translateHome4, translateHome5, translateHome6, translateHome7, translateHome8, translateHome9,
        ...
        bgClass, ffClass, bwClass} = useTranslateContext();
    ...
    return (
        <>
            ...
            <div className='home-container'>
                <div className={`home-sub-container ${bwClass ? 'flecha-container' : ''}`}>
                    <h2 className='title-inicio mg-auto title-change'>Laguna Léxica invita a un recorrido no lineal a través de la lengua muerta yagán. En un intento por evitar su extinción, esperamos que esta obra le rinda homenaje en sus últimos años de vida.</h2>
                    <img src={flecha} alt="Flecha Yagan" className={bwClass ? 'flecha' : 'no-visible'}/>
